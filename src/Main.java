...
public class Main {
    ...
    public static void executar(List<Usuario> usuarios, List<Cliente> clientes, List<Empresa> empresas,
        ...
        Usuario usuarioLogado = userAuthentication(usuarios, username, senha);
        ...
        if (usuarioLogado != null) {
            ...
            if (usuarioLogado.isAdmin()) {                
                ...
                while(true){
					...
					switch (escolha) {
						case 1:
							showCompanySales(usuarioLogado, vendas);
							break;
						case 2:
							showCompanyProducts(usuarioLogado, produtos);
							break;
						case 0:
							executar(usuarios, clientes, empresas, produtos, carrinho, vendas);
						case 9:
				...
				while(true){
					...
					switch (escolha) {
						case 1:
							makePurchase(usuarioLogado, empresas, produtos, carrinho, vendas, clientes);
							break;
						case 2:
							showClientPurchase(usuarioLogado, vendas);
							break;
						case 0:
							executar(usuarios, clientes, empresas, produtos, carrinho, vendas);
						case 9:
    ...
    private static void showCompanySales(Usuario empresa, List<Venda> vendas) {
        System.out.println();
		System.out.println("************************************************************");
    ...
    private static void showCompanyProducts(Usuario empresa, List<Produto> produtos) {
        System.out.println();
		System.out.println("************************************************************");
    ...
    private static void makePurchase(Usuario cliente, List<Empresa> empresas, List<Produto> produtos,
    ...
    private static void showClientPurchase(Usuario cliente, List<Venda> vendas) {
        System.out.println();
		System.out.println("************************************************************");
	...
	private static void showCompanies(List<Empresa> empresas) {
		...
		System.out.println("Escolha o ID da empresa para ver os detalhes: ");
		empresas.stream().forEach(x -> {
			System.out.println(x.getId() + " - " + x.getNome());
		});
		System.out.println("0 - Deslogar");
		...
		for (Empresa empresa : empresas) {
			if (empresa.getId() == escolhaEmpresa) {
		...
		if (empresaSelecionada != null) {			
			...
			System.out.println("ID: " + empresaSelecionada.getId());
			System.out.println("Nome: " + empresaSelecionada.getNome());
			System.out.println("CNPJ: " + empresaSelecionada.getCnpj());
			System.out.println("Taxa: " + empresaSelecionada.getTaxa());			
		} else {
